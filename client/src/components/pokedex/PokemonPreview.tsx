...
const PokemonPreview = ({ pokemonSpeciesID }: { pokemonSpeciesID: string }) => {
    ...
    return (
        <div>
            ...
            <div className="mb-4 flex flex-col rounded border border-gray-300 p-2">
                ...
                <div className="flex flex-row m-2">
                    ...
                    <div className="relative size-90">
                        {/* Main Preview Image */}
                        <img src={previewPokemon?.sprite} alt="Preview Pokemon Image" className="w-full h-full rounded-lg border-2" />
                        <div className="absolute bottom-0 left-0 z-10">
                            <button
                                className="w-16 h-16 bg-blue-500 hover:bg-blue-700 transition-all"
            ...
            <Tabs defaultValue="basics" className="w-full">
                ...
                <TabsContent value="basics" className="w-full">
                    <ScrollArea className="h-[200px] w-[350px] rounded-md border p-4">
                        Height, Weight, Abilities, Base Stats
                    </ScrollArea>
                </TabsContent>
